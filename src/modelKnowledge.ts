...
const KNOWLEDGE_TABLE: ReadonlyArray<readonly [RegExp, ModelKnowledge]> = [
    // --- Anthropic -------------------------------------------------------
    [/claude-(fable|mythos)-5/, { contextWindow: 200_000, maxOutputTokens: 64_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    [/claude-opus-5|claude-opus-4-8|claude-opus-4-7|claude-opus-4-6|claude-opus-4-5/, { contextWindow: 200_000, maxOutputTokens: 64_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    [/claude-sonnet-5|claude-sonnet-4/, { contextWindow: 200_000, maxOutputTokens: 64_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    ...
    // --- OpenAI ----------------------------------------------------------
    [/gpt-5\.(6|5|4|3|2|1)|gpt-6-astra/, { contextWindow: 400_000, maxOutputTokens: 128_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    [/gpt-5-nano|gpt-5\b|gpt-5-codex/, { contextWindow: 400_000, maxOutputTokens: 128_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    ...
    // --- DeepSeek --------------------------------------------------------
    [/deepseek-v4-pro|deepseek-v4\.1|deepseek-v4-flash|deepseek-flash/, { contextWindow: 128_000, maxOutputTokens: 64_000, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    // --- Z.AI / GLM ------------------------------------------------------
    ...
    // --- Moonshot / Kimi -------------------------------------------------
    [/kimi-k3|kimi-k2\.7|kimi-k2\.6|kimi-k2\.5/, { contextWindow: 256_000, maxOutputTokens: 32_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    // --- MiniMax ---------------------------------------------------------
    ...
    // --- Qwen ------------------------------------------------------------
    [/qwen3\.8|qwen3\.7|qwen3\.6|qwen3\.5/, { contextWindow: 262_144, maxOutputTokens: 32_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    // --- Meta Muse Spark -------------------------------------------------
    [/muse-spark/, { contextWindow: 262_144, maxOutputTokens: 32_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    // --- Xiaomi MiMo -----------------------------------------------------
    [/mimo-v2/, { contextWindow: 262_144, maxOutputTokens: 32_000, supportsVision: true, supportsTools: true, supportsReasoning: true, reasoningLevels: ['low', 'medium', 'high'] }],
    // --- Others ----------------------------------------------------------
